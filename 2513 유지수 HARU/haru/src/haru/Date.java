...
public class Date extends JFrame {
	...
	private JLabel menuBar = new JLabel(new ImageIcon("C:\\Users\\LG\\Downloads\\javaproject\\menubar.png"));
	...
	public Date() {
		...
		MainButton.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/home_icon.png")));
		...
		WriteButton.setIcon(new ImageIcon(getClass().getClassLoader().getResource("write_icon.png")));
